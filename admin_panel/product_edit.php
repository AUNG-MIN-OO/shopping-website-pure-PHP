...
//                            print_r($result);
                            ...
                            <div class="form-group">
                                <label for="">Description</label><p style="color:#ff0000"><?php echo empty($descError) ? '' : '*'.$descError; ?></p>
                                <textarea class="form-control" name="description" rows="8" cols="80"><?php echo $result[0]['category_id']; ?></textarea>
                            </div>
                            <div class="form-group">
                                <?php
                                ...
                                <select class="form-control" class="" name="category">
                                    ...
                                    <?php foreach ($catResult as $value) { ?>
                                        <option <?php echo $value['id']==$result[0]['category_id'] ? 'selected' : '';?> value="<?php echo $value['id'] ?>">
                                            <?php echo $value['name']?>
                                        </option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group">
                                <label for="">Choose New Image</label><p style="color:red"><?php echo empty($imageError) ? '' : '*'.$imageError; ?></p>
                                <img src="images/<?php echo $result[0]['image']; ?>" alt="" style="width: 100px;height: 150px;">
                                <br>
